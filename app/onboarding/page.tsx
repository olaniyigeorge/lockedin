    ...
    return (
        <div className="onboarding-container">
            ...
            <section className="onboarding-section">
                ...
                <p className="onboarding-text"><strong>Vision</strong>: <em>“LockedIn is more than a habit tracker; it’s a commitment system.”</em></p>
            ...
            <section className="onboarding-section">
                ...
                <p className="onboarding-text"><strong>Tagline</strong>: <em>“Stay LockedIn. Stay Accountable. Build Lasting Habits.”</em></p>
