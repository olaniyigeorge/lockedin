...
export default function SignInUpForm() {
    ...
    return (
        <div className="w-full p-3 md:p-6 flex justify-center min-h-[500px] items-center ">
            <form className="w-full max-w-[450px]  gap-3 glassmorphism p-10 rounded-xl flex flex-col justify-center items-center border border-slate-200" onSubmit={handleSubmit}>
