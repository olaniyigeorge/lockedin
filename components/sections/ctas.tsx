        ...
        <div className="w-full py-16  bg-gradient-to-b from-white to-green-300 bg-transparent text-white text-center px-2">
          <section id="cta-2" className="main flex flex-col justify-center items-center relative">
            ...
            <Image 
              ...
              width={200} 
              height={200} 
              className="bottom-[80px] left-4 md:top-0 md:left-24 w-10 md:w-[200px] absolute z-100 object-file rotate-6"
            />
            <Image 
              src="/imgs/streak.png"
              alt="streak" 
              width={200} 
              height={200} 
              className="bottom-[80px] right-4 md:top-0 md:right-16 w-10 md:w-[200px]  absolute z-100 object-file rotate-6"
            />
          </section>  </div>
      );
    }
