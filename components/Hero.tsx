...
export const Hero = () => {
  return (
    <div className="bg-gradient-to-tr from-green-200 via-orange-50 to-orange-100 w-full py-6">
      <div className="relative w-full py-2">
        <div className="w-[90%] mx-auto flex flex-col justify-center items-center ">
          <div className="flex flex-col items-center justify-center text-center gap-6 md:text-lg lg:text-xl">
            ...
            <p className="w-[90%] md:w-[70%] lg:w-[50%] leading-[35px] md:leading-[42px] text-gray-900 font-semibold">
